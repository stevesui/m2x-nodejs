...
/*
*
* This example demonstrates how to remove device from collection
*
* API Documentation:
...
console.log("Removing device: %s from collection: %s ", device_id, collection_id);

m2x_client.collections.removeDevice(collection_id, device_id, function(response) {
